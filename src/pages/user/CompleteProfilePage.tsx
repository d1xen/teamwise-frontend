// src/pages/user/CompleteProfilePage.tsx
...
type FormErrors = Partial<Record<keyof UserProfileUpdate, string>>;
...
export default function CompleteProfilePage() {
    ...
    const [form, setForm] = useState<UserProfileUpdate>(EMPTY_FORM);
