...
import { getMatch, updateMatch as updateMatchApi, updateMapScore as updateMapScoreApi, deleteMatch as deleteMatchApi, getMatchNotes, addMatchNote, deleteMatchNote } from "@/api/endpoints/match.api";
                    ...
                    {isStaff && (
                        <>
                            <button onClick={() => setShowEdit(true)}
                                ...
                                {match.state === "TO_COMPLETE" ? t("matches.complete") : t("common.edit")}
                            </button>
                            {canDelete && (
            ...
            <div className="bg-neutral-900/50 border border-neutral-800 rounded-2xl p-6">
                ...
                {match.competitionName && (
                    <div className="flex items-center gap-1.5 mt-4">
                        ...
                        <span className="text-xs text-neutral-300">{match.competitionName}</span>
                        {match.competitionStage && <span className="text-xs text-neutral-600">· {match.competitionStage}</span>}
                    </div>
                )}
